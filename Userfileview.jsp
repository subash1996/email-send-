...
PreparedStatement p = d.prepareStatement("SELECT Id,filename,filetype,filesize FROM  publiccloud.fileupload f");
...
<td><%=s.getString(3)%></td>
 <td><%=s.getString(4)%></td>   
<td align="left"><a href="UserRequestServlet?Id=<%=Id%>&& file=<%=filename%>" method="post"><button class="btn btn-danger"  >Request key</button></a></td>
</tr> 
  <%}%>  
</table> 
