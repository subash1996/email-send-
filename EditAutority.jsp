...
<body>
<form action="Update.jsp" name="form">
...
PreparedStatement p = d.prepareStatement("SELECT * FROM publiccloud.userrequest where sno='"+no+"'");
...
username=s.getString(6); 
 ...
 <tr>
<td><input type="hidden" name="id" value="<%=s.getString(1)%>"></td>
<td><%=s.getString(2)%></td>
<td><%=s.getString(3)%></td>
 <td><%=s.getString(6)%></td> 
  <td><input type="text" name="edit" value="<%=s.getString(7)%>"></td>  
<td><input type="submit" name="Submit" value="Update" style="background-color:#49743D;font-weight:bold;color:#ffffff;"></td></tr> 
  <%}%>  
</table>
</form>   
</body>
